$(function () {
    ...
    // 获取订单信息列表的URL
    var getOrderListURL = '/campus_life/client/getorderlist';
            ...
            if (data.success) {
                ...
                data.orderInfoList.map(function (item, index) {
                    ...
                    html += '' + '<div class="card" data-product-id="'
                        + item.productInfo.id + '">' + '<div class="card-header">'
                        + item.productInfo.name + '</div>'
                        ...
                        + '<div class="item-subtitle">' + item.productInfo.des
                        + '</div>' + '</div>' + '</li>' + '</ul>'
