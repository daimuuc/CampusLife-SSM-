...
public class CartInfoExecution {
    ...
    public CartInfoExecution() {

    }

    // 操作失败的时候使用的构造器
    public CartInfoExecution(CartInfoEnum stateEnum) {
        this.state = stateEnum.getState();
        this.stateInfo = stateEnum.getStateInfo();
    }

    // 操作成功的时候使用的构造器
    public CartInfoExecution(CartInfoEnum stateEnum, CartInfo cartInfo) {
        this.state = stateEnum.getState();
        this.stateInfo = stateEnum.getStateInfo();
    ...
    // 操作成功的时候使用的构造器
    public CartInfoExecution(CartInfoEnum stateEnum, List<CartInfo> cartInfoList) {
        this.state = stateEnum.getState();
        this.stateInfo = stateEnum.getStateInfo();
